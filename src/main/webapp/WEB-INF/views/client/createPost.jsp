    ...
    <c:when test="${not empty sessionScope.currentUser}">
        <div class="container">
            <div class="row">
                ...
                <div class="col-9">
                    <form method="post"
                          action="${pageContext.request.contextPath}/createPostFromUser"
                          class="user_form "
                        ...
                        <div class="row item">
                            <div class="row item_sub item_sub_first">
                                ...
                                <div class=" col-9 item_input">
                                    <input name="area" class="pro_acreage" type="number" id="pro_acreage" value="">
                                </div>
                            </div>
                            ...
                            <div class="row item_sub item_sub_last">
                                ...
                                <div class=" col-9 item_input">
                                    <input name="addressDetail" class="pro_addr" type="text" id="pro_addr" value="">
                                </div>
                            </div>
                        ...
                        <div class="item">
                            <div class="item_sub item_sub_first row">
                                ...
                                <div class="col-9 item_input">
                                    <input name="price" class="pro_price" type="number" id="pro_price" value="">
                                </div>
                            </div>
                            <div class="item_sub">
    ...
    <div class="toast-container position-absolute top-0 end-0 p-3" id="toastPlacement">
        ...
        <div class="toast" id="liveToast" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
                <strong class="me-auto" id="toastHeader">Header</strong>
