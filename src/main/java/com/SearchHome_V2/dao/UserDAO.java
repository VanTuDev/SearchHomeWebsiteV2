...
public interface UserDAO extends DAO<User> {
    @Override
    @SqlUpdate("INSERT INTO user (username, password, fullName, gender, phoneNumber, email, cccd, role, imageName)" +
            "VALUES (:username, :password, :fullName, :gender, :phoneNumber, :email, :cccd, :role,:imageName)")
    @GetGeneratedKeys("id")
