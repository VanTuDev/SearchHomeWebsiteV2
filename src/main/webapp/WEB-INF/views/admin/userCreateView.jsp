...
<section class="section-content">
    <div class="container">
        ...
        <main class="row mb-5">
            <form class="col-lg-6" method="POST" action="${pageContext.request.contextPath}/admin/userManager/create"  enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="user-address" class="form-label">Căng cước công dân <span class="text-danger">*</span></label>
                    <input type="text"
                           class="form-control ${not empty requestScope.violations.cccdViolations
                   ? 'is-invalid' : (not empty requestScope.user.cccd ? 'is-valid' : '')}"
                           id="user-address"
                           name="cccd"
                           value="${requestScope.user.cccd}"
                           required>
