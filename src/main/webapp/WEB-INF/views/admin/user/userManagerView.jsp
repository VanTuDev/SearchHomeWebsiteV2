      ...
      <table class="table table-bordered table-striped table-hover align-middle">
        ...
        <c:forEach var="user" varStatus="loop" items="${requestScope.users}">
          <tr>
            ...
            <td>
              <c:choose>
                <c:when test="${empty user.imageName}">
                  <img width="38" src="${pageContext.request.contextPath}/img/50px.png"
                       alt="50px.png">
                </c:when>
                <c:otherwise>
                  <img width=59 src="${pageContext.request.contextPath}/image/${user.imageName}">
                </c:otherwise>
            ...
            <td>
              <c:choose>
                ...
                <c:when test="${user.role == 'EMPLOYEE'}">Người cho Thuê</c:when>
