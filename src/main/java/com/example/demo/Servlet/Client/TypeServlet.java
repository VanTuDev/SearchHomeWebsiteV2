...
public class TypeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        long roomTypeId = Protector.of(() -> Long.parseLong(req.getParameter("id"))).get(0L);
        int totalPost = Protector.of(() -> postService.countByQueryType(roomTypeId)).get(0);
        ...
        List<Post> posts = Protector.of(() -> postService.getPostByRoomType(
                roomTypeId, POST_PER_PAGE, offset
        )).get(ArrayList::new);
        ...
        req.getRequestDispatcher("/WEB-INF/views/client/typeView.jsp").forward(req, resp);
